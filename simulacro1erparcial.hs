...
--3) para la función eliminar repetidos: hago función quitarTodos y pertenece. en realidad 
--la función quitarTodos es redundante xq si x pertenece a xs, pongo eliminarRepetidos xs y
--con eso ya se eliminan los x repetidos y el primer elemento x, q tmb se repetía
